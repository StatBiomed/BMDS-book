...
# library(pROC)
roc_summary <- pROC::roc(cv_res$obs == 'pos', cv_res$pos)
print(paste("The AUC score of this ROC curve is", roc_summary$auc))

roc_table <- as.data.frame(
  roc_summary[c("sensitivities", "specificities", "thresholds")]
)
head(roc_table)
```
