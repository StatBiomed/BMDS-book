...
# The PimaIndiansDiabetes has been removed from mlbench v2.1-10 for licence issue.
# if (!requireNamespace("mlbench", quietly = TRUE)) {
#   install.packages("remotes")
#   remotes::install_version("mlbench", version = "2.1-9")
# }
# data(PimaIndiansDiabetes, package = "mlbench")
# write.csv(PimaIndiansDiabetes, "mlbench_v2.1-9_PimaIndiansDiabetes.csv", row.names = FALSE)

# Load data
PimaIndiansDiabetes = read.csv("mlbench_v2.1-9_PimaIndiansDiabetes.csv", 
