...
- Choose the ``base`` and then Click on the ``Download R 4.4.1 for Windows``
...
- Once the download is finished, you will obtain a file named 
  ``R-4.4.1-win.exe`` or similar depending on the version that you download.
...
- Click on the file containing the latest version of R under the 
  **Latest release**.
- Save the ``R-4.4.1-**.pkg`` file, double-click it to open, and follow the installation 
  instructions. 
