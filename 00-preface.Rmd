...
It can also support general readers who are new to (biomedical) data science, 
including students in a master programme course 
...
2) Epidemiology, by Dr Ray Hsu
3) Cancer genomics, by Dr David Shih
...
3. [Introduction to Modern Statistics](https://www.openintro.org/book/ims/) 
   by Mine Çetinkaya-Rundel and Johanna Hardin (free PDF and html available)
4. [An Introduction to Statistical Learning](https://www.statlearning.com/)
   ...
   (free PDF available; meddle to advanced levels)
...
- Student helpers: Mr Mingze Gao, Ms Fangxin Cai, Mr Hoi Man Chung, Mr Tianjie Wang
