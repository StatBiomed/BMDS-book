...
```{r child="notebooks/chapter1-R/01-introR_week1.Rmd", echo=TRUE}
```

```{r child="notebooks/chapter1-R/01-introR_week2-1.Rmd", echo=TRUE}
```

```{r child="notebooks/chapter1-R/01-introR_week3-1.Rmd", echo=TRUE}
```

# Introduction to Hypothesis test {#introHypoTest}
...
```{r child="notebooks/chapter4-HT/04-hypothesis-test-03.Rmd", echo=TRUE}
```
